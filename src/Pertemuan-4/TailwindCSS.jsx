...
function Spacing(){
    return (
        <div className="bg-amber-100 shadow-lg p-6 m-4 rounded-lg">
...
function Typography(){
    return (
        <div>
            ...
            <p className="text-red-600 text-lg mt-2">Belajar Tailwind sangat menyenangkan dan cepat!</p>
        </div>
    )
}
...
function ShadowEffects(){
    return (
        <div className="bg-cyan-300 shadow-lg p-6 rounded-lg hover:shadow-2xl transition">
