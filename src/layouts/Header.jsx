    ...
    <div id="header-container" className="flex justify-between items-center p-4">
      ...
      <div id="search-bar" className="relative w-full max-w-lg">
        <input
          ...
          className="border border-gray-100 p-2 pr-10 bg-white w-full rounded-md outline-none text-gray-600"
        />
      ...
      <div id="icons-container" className="flex items-center space-x-4">
        ...
        <div id="notification-icon" className="relative p-3 bg-blue-100 rounded-2xl text-blue-500 cursor-pointer">
          <FaBell />
          <span id="notification-badge" className="absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 bg-blue-200 rounded-full px-2 py-1 text-xs text-white">
            50
          </span>
        </div>
        ...
        <div id="settings-icon" className="p-3 bg-red-100 rounded-2xl text-merah cursor-pointer">
          <SlSettings />
        </div>
        ...
        <div id="profile-container" className="flex items-center space-x-4 border-l pl-4 border-gray-300">
          <span id="profile-text" className="text-gray-600">
            Hello, <b className="text-gray-900">Gadosrull</b>
          </span>
          <img
            id="profile-avatar"
            src="/public/img/yy.jpg"
